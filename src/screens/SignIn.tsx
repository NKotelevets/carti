    ...
    <StyledAuthScreens>
      ...
      <div className='content-wrapper'>
        <div className='form-wrapper'>
          <PhoneAuth title={'LOG IN TO YOUR ACCOUNT'} subtitle={'Don’t have an account? '} subtitleLinkText={'Create Account'} subtitleLinkPath={'/'} stepsCount={2} />
        </div>
